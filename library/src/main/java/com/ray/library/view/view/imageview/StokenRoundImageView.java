...
public class StokenRoundImageView extends android.support.v7.widget.AppCompatImageView {
    ...
    public StokenRoundImageView(Context context) {
    ...
    public StokenRoundImageView(Context context, AttributeSet attrs) {
    ...
    public StokenRoundImageView(Context context, AttributeSet attrs, int defStyle) {
