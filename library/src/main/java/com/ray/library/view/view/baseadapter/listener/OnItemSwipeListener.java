package com.ray.library.view.view.baseadapter.listener;
...
public interface OnItemSwipeListener {
    ...
    /**
     * Called when the swipe action go.
     */
    void onItemSwipeStart(RecyclerView.ViewHolder viewHolder, int pos);

    /**
     * Called when the swipe action is over.
     * If you change the view on the go, you should reset is here, no matter the item has swiped or not.
     ...
     * @param viewHolder The ViewHolder which is being interacted by the UserDemo or it was
