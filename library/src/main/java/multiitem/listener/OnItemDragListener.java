...
import multiitem.helper.ViewScaleHelper;
import multiitem.item.ItemData;
import multiitem.item.ItemDrag;
 ...
 * <p>
 * ？ 支持带有header和footer的列表，move add remove的时候需要减去head数量，移动之前需要判断是否为head foot则不允许拖动
...
public abstract class OnItemDragListener {
     ...
     * 计算垂直水平距离
     * <p>
     *  可参考ItemTouchHelper改造成加速器形式 还有calcVerticalScrollDistance
     *
     * @return 水平滚动距离
     */
