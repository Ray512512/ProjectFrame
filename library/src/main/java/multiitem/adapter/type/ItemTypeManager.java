package multiitem.adapter.type;
...
import multiitem.item.ItemManager;
...
public class ItemTypeManager {
     ...
     * @see BaseItemAdapter#register(Class, ViewHolderManager)
     */
     ...
     * @see BaseItemAdapter#register(Class, ViewHolderManagerGroup)
     */
