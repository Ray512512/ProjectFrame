package com.ray.projectframe.imgseletor.adapter;
...
import com.ray.projectframe.imgseletor.MultiImageSelectorFragment;
...
public class ImageGridAdapter extends BaseAdapter {
    ...
    public ImageGridAdapter(Context context, boolean showCamera, int column){
        ...
        errorDrawable=context.getResources().getDrawable(R.drawable.mis_default_error);
    }
    /**
     * 显示选择指示器
     * @param b
