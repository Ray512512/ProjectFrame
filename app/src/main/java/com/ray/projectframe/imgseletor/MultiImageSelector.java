...
public class MultiImageSelector {
    ...
    private boolean mShowCamera = false,mOnlyCamera=false;
    ...
    public MultiImageSelector onlyCamera(boolean mOnlyCamera){
        this.mOnlyCamera = mOnlyCamera;
        return sSelector;
    }
    ...
    private Intent createIntent(Context context){
        ...
        intent.putExtra(MultiImageSelectorActivity.EXTAR_ONLY_CAMERA, mOnlyCamera);
        if(mOriginData != null){
